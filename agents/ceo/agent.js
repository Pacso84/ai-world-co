...
async function main() {
  ...
  // 4/0a. POSTÁS (2026-07-13, cég-hierarchia): visszaadott munkák kézbesítése
  ...
  console.log('\n━━━ 0. LÉPÉS: FŐNÖK-ASZTAL ━━━');
  const deskResult = await runAgent('agents/ceo/desk.js');
  session.stages.desk = { exit_code: deskResult.code };
